...
.. admonition:: Æfing: Listablús
   ...
   b) Flettið upp á *insert*-fallinu í grein :numref:`bara-listar` og notið
...
.. admonition:: Æfing: enumerate og zip 
   ...
   b) Smíðið sömu pör með *zip*.

   c) Látið ``nöfn`` vera nafnalistann í sýnidæminu "Nöfn og númer" og ``eink`` vera
