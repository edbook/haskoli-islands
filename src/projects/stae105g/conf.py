...
# -*- coding: utf-8 -*-
#
# Hagnýt stæðrfræðigreining documentation build configuration file, created by
...
man_pages = [
    (
        "index",
        "strfrigreiningi",
        "Hagnýt stærðfræðigreining Documentation",
        ["Valentina Giangreco M Puletti"],
        1,
    )
]
...
# epub_author = 'HagnytStaerdfraerdigreining'
# epub_publisher = 'Benedikt Steinar Magnússon'
# epub_copyright = '2021, Valentina Giangreco M Puletti'

# The basename for the epub file. It defaults to the project name.
# epub_basename = 'Hagnýt stærðfræðigreining'
