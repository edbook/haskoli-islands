...
#datacamp_path = 'https://cdn.datacamp.com/dcl-react-dev.js.gz'
...
project = 'Stærðfræði og reiknifræði'
copyright = '2019, Kristján Jónasson'
...
# documentation.
# html_theme_options = {'sidebarwidth': '8rem'}
