...
from Sphinx_ext import htmlform, common
...
class InstructorFeedbackDirective(Directive):
    ...
    def run(self):
        ...
        result = htmlform.HtmlForm(args=self.arguments,
                                   button_name=button_name,
                                   p_to_static=p_to_static)
        
        # Add an input field containing the event-name
        result += htmlform.HtmlInput(args=['event-name'],
                                     el_type='hidden',
                                     checked='',
                                     maxlength='',
        ...
        result += htmlform.HtmlTextarea(args=["msg"],
                                        rows=rows,
