...
def setup(app):
    app.add_node(datacamp, html=(html_visit_datacamp_node, html_depart_datacamp_node))
    app.add_node(
        hidden_datacamp,
