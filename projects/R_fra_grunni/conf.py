...
# To make 'R' language syntax highlighting of code snippets
...
project = 'R frá Grunni'
copyright = '2018, Sigrún Helga Lund, Anna Helga Jónsdóttir & Bjarki Þór Elvarsson'
author = 'Sigrún Helga Lund, Anna Helga Jónsdóttir & Bjarki Þór Elvarsson'
...
latex_documents = [
  (master_doc, 'RfG.tex', 'R frá grunni',
   'Sigrún Helga Lund, Anna Helga Jónsdóttir & Bjarki Þór Elvarsson', 'manual'),
]
