...
reps = {
    ...
    re.compile(r"( \\fi\n\\fi\n)(\\usepackage\{cmap\})"): (
        ...
        r" language=R,                       % the language of the code\n "
        r" %basicstyle=\\tiny\\ttfamily,       % the size of the fonts that are used for the code\n"
        r"  numbers=left,                     % where to put the line-numbers\n "
        r" numberstyle=\\color{Blue},         % the style that is used for the line-numbers\n "
        r" stepnumber=1,                     % the step between two line-numbers. If it is 1, each"
        r" line\n                                    % will be numbered\n  numbersep=5pt,          "
        r"          % how far the line-numbers are from the code\n  backgroundcolor=\\color{white},"
        r"    % choose the background color. You must add\\usepackage{color}\n  showspaces=false,  "
        r"               % show spaces adding particular underscores\n  showstringspaces=false,    "
        r"       % underline spaces within strings\n  showtabs=false,                   % show tabs"
        r" within strings adding particular underscores\n  frame=single,                     % adds"
        r" a frame around the code\n  rulecolor=\\color{black},          % if not set, the"
        r" frame-color may be changed on line-breaks\n                                    % within"
        r" not-black text (e.g. comments (green here))\n  tabsize=2,                        % sets"
        r" default tabsize to 2 spaces\n  captionpos=b,                     % sets the"
        r" caption-position to bottom\n  breaklines=true,                  % sets automatic line"
        r" breaking\n  breakatwhitespace=false,          % sets if automatic breaks should only"
        r" happen at whitespace\n  keywordstyle=\\color{RoyalBlue},   % keyword style\n "
        r" commentstyle=\\color{YellowGreen}, % comment style\n  stringstyle=\\color{ForestGreen}  "
        r" % string literal style\n}\n\n\2"
    ),
    # 'sub': 'dub'
}
