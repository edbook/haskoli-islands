...
%\subsection{Yfirlit}
%\subsubsection{Kafli 4: Eigingildisverkefni}
%\begin{center}
...
%\subsection{4.2 Andhverf veldaaðferð} 
...
%\subsection{4.2 Reiknirit til þess að ákvarða eigingildi} 
