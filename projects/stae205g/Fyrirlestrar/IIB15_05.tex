...
\begin {block}{Skilgreining 5.\arabic{mycount}}\stepcounter{mycount}
...
\begin {frame}
\Wider{\begin {block}{Ritháttur 5.\arabic{mycount}}\stepcounter{mycount}
...
\begin {frame}{Hlutafleiður af hærra stigi}
 \begin {block}{Setning 5.\arabic{mycount}}\stepcounter{mycount}
...
\begin {frame}{Hlutafleiður af hærra stigi}
 \begin {block}{Hugmynd að skilgreiningu 5.\arabic{mycount}}\stepcounter{mycount}
...
\begin {frame}
 \begin {block}{Setning 5.\arabic{mycount} (Almenn útgáfa af Setningu~5.7)}\stepcounter{mycount}
     Látum $f$ vera
