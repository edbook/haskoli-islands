...
\begin {block}{Skilgreining 2.\arabic{mycount}}\stepcounter{mycount}
...
\begin{frame}{Pólhnit}
\begin {block}{Regla 2.\arabic{mycount}}\stepcounter{mycount}
...
\begin {frame}{Pólhnitagraf}
\begin {block} {Skilgreining og umræða 2.\arabic{mycount} }\refstepcounter{mycount}Látum $f$ vera fall skilgreint fyrir 
$\theta$ þannig að 
...
\begin {frame}{Snertill við pólhnitagraf}
 \begin {block}{Setning 2.\arabic{mycount}}\refstepcounter{mycount}
