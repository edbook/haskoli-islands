...
En snertill við graf fallsins í punktinum :math:`a` er línan sem fer gegnum punktinn
:math:`(a,f(a))` og hefur hallatöluna :math:`f'(a)`. Jafna snertilsins er gefin með
