...
\begin{tikzpicture}[scale=5.3,cap=round,>=latex]
  ...
  \draw (0.2, 0) arc [radius = 0.2, start angle = 0, end angle = 120];

  \draw (0.15, 0) arc [radius = 0.15, start angle = 0, end angle = 300];
  ...
  \draw (0cm,0cm) -- (120:1cm);
  \draw (0cm,0cm) -- (300:1cm);
  ...
  \draw [red, thick] (-0.5,0) -- (-0.5,0.866)--(jy3);
  ...
  \draw [red, thick] (jx1) -- (0.5, - 0.866)--(ny3);
