...
\begin{tikzpicture}[scale=5.3,cap=round,>=latex]
  ...
  \draw (0.2, 0) arc [radius = 0.2, start angle = 0, end angle = 30];

  \draw (0.15, 0) arc [radius = 0.15, start angle = 0, end angle = 150];
  ...
  \draw [red, thick] (-0.866,0.5)--(jy1)--(0.866,0.5);
