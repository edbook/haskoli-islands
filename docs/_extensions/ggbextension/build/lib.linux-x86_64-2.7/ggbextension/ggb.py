...
def html_visit_ggb_node(self, node):
    ...
    self.body.append(
        "<iframe src='https://tube.geogebra.org/material/iframe/id/"
        + node["id"]
        + "/width/"
        + node["width"]
        + "/height/"
        + node["height"]
        + "/border/888888/rc/false/ai/false/sdz/"
        + node["zoom_drag"]
        + "/smb/false/stb/false/stbh/true/ld/false/sri/true/at/auto' width="
        + node["width"]
        + " height="
        + node["height"]
        + " frameborder='0'>"
...
def setup(app):
    app.add_node(
        ggb,
        html=(html_visit_ggb_node, html_depart_ggb_node),
        latex=(tex_visit_ggb_node, tex_depart_ggb_node),
    )
